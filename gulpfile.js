...
gulp.task(
	'buildDist',
	gulp.series('clean', 'buildStyles', 'vendorsJS', 'customJS', 'buildFiles', 'buildImages', function(done) {
		done();
	})
);
...
gulp.task(
	'build',
	gulp.series('clean', 'buildStyles', 'vendorsJS', 'customJS', 'buildFiles', 'buildImages', 'buildZip', function(
		done
	) {
		done();
	})
